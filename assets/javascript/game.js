//apollo trivia game javascript code
$(document).ready(function() {
    //global variables
        //Apollo missions questions:  source https://www.funtrivia.com/en/History/Apollo-Missions-10284.html
              const qnaArray = [
                  {
    ...
    //              nextQ();
        ...
        function nextQ() {
            if (i < (qnaArray.length-1)) {
                console.log("nextQ, qnaArray length = " + qnaArray.length);
                console.log("nextQ i = " + i);
          ...
          $("#start").on("click", function () {        //  Start on click. 
              ...
              qCounter = 1;
                  $("#start").remove();
                  $("#timeRem").text("Time Remaining: " +30);
                  runQ();
    //              reset();
